...
class Product {
    ...
    save = ()=>{
        ...
        if(this.id == 0){
            this.query = "INSERT INTO products(name, imagename, pcid, description, specification, mrp, price, stock, availability, status) ";
            this.query += "VALUES('" + this.name + "', '" + this.imagename + "', " + this.pcid + ", '" + this.description + "', '" + this.specification + "', ";
            this.query += this.mrp + ", " + this.price + ", " + this.stock + ", '" + this.availability + "', 'active')";
        }
        else{
            ...
            this.query += "availability = '" + this.availability + "', ";
